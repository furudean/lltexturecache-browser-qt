...
from lltexturecache_browser_qt.panes.sidebar import drawn_size, paint, stand_in_card, standing_cards
...
class TestShape:
    ...
    def test_a_decoded_texture_reports_the_size_it_was_drawn_at(self, model: TextureModel) -> None:
        ...
        assert drawn_size(model, model.texture(0)) == QSize(512, 256)
    ...
    def test_a_texture_that_would_not_decode_reports_an_empty_size(self, model: TextureModel) -> None:
        ...
        assert drawn_size(model, model.texture(0)) == QSize()
